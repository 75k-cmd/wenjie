...
def init_args():
    ...
    parser.add_argument("--use_gpu", type=str2bool, default=False)  # 改：True -> False
    ...
    parser.add_argument("--det_model_dir", type=str, default="./inference/ch_pp-OCRv4_det_infer")  # 改：添加默认路径
    ...
    parser.add_argument("--rec_model_dir", type=str, default="./inference/ch_pp-OCRv4_rec_infer")  # 改：添加默认路径
    ...
    parser.add_argument("--use_angle_cls", type=str2bool, default=True)  # 改：False -> True
    parser.add_argument("--cls_model_dir", type=str, default="./inference/ch_ppocr_mobile_v2.0_cls_infer")  # 改：添加默认路径
